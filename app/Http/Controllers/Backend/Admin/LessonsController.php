...
class LessonsController extends Controller
{
    ...
    public function store(StoreLessonsRequest $request)
    {
        ...
        $lesson->slug = $slug;
        $lesson->backup_link_1 = $request->backup_link_1;
        $lesson->backup_link_2 = $request->backup_link_2;
        $lesson->downloadable_files_pass = str_encrypt($request->downloadable_files_pass);
        $lesson->save();
...
//        $request = $this->saveAllFiles($request, 'downloadable_files', Lesson::class, $lesson,$folder);
    ...
    public function edit($id)
    {
        ...
        $lesson->downloadable_files_pass = str_decrypt($lesson->downloadable_files_pass);
