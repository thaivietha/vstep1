            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="form-group row">
                        {{ html()->label(__('labels.backend.students.fields.username'))->class('col-md-2 form-control-label')->for('username') }}

                        <div class="col-md-10">
                            {{ html()->text('username')
                                ->class('form-control')
                                ->placeholder(__('labels.backend.students.fields.username'))
