                ...
                <div class="col-12">
                    <div class="table-responsive">
                        ...
                        <table id="myTable"
                            ...
                            {{--                        <table id="myTable" class="table table-striped table-bordered dt-responsive data-table dataTable no-footer dtr-inline collapsed @can('category_delete') @if ( request('show_deleted') != 1 ) dt-select @endif @endcan">--}}
                            <thead>
                            <tr>
                                ...
                                <th style="width: 5%;">@lang('labels.general.sr_no')</th>
                                {{--                                <th>@lang('labels.general.id')</th>--}}
                                <th style="width: 25%;">@lang('labels.backend.categories.fields.name')</th>
                                <th style="width: 25%;">@lang('labels.backend.categories.fields.slug')</th>
                                <th style="width: 10%;">@lang('labels.backend.categories.fields.icon')</th>
                                <th style="width: 10%;">@lang('labels.backend.categories.fields.courses')</th>
                                <th style="width: 10%;">@lang('labels.backend.categories.fields.blog')</th>
                                @if( request('show_deleted') == 1 )
                                    <th style="width: 10%;">&nbsp; @lang('strings.backend.general.actions')</th>
                                @else
                                    <th style="width: 10%;">&nbsp; @lang('strings.backend.general.actions')</th>
                                @endif
                            </tr>
